...
if(!file.exists("~/Documents/GitHub/covid_vaccines_virulence_evolution/sim.data/strong.natural.omega0p.vacc0.5alpha.optim0.01.RDS"))
{
  n.cores<-detectCores()
  ...
  saveRDS(out.data,file="~/Documents/GitHub/covid_vaccines_virulence_evolution/sim.data/strong.natural.omega0p.vacc0.5alpha.optim0.01.RDS")
}
