...
if(!file.exists("~/Documents/GitHub/covid_vaccines_virulence_evolution/sim.data/small.epsilon.omega0p.vacc0.9alpha.optim0.01.RDS"))
{
  n.cores<-detectCores()
  ...
  saveRDS(out.data,file="~/Documents/GitHub/covid_vaccines_virulence_evolution/sim.data/small.epsilon.omega0p.vacc0.9alpha.optim0.01.RDS")
}
