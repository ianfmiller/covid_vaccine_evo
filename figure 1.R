...
points(A,trans.rates1,col=viridis(3)[2],type="l",lwd=12,lty=1)
mtext("A",side=3,line=1,font=2,adj=0,padj = 0)

#par(fig = c(1/3,2/3, 0, 1), new = T)
plot(A,death.rates1,xlim=c(.0025,.021),ylim=c(0,4),xlab="virulence",ylab="transmisison time",type="n",cex.lab=2,cex.axis=1.2)
points(A,death.rates1,col=viridis(3)[2],type="l",lwd=12,lty=1)
...
points(A,R0s1,col=viridis(3)[2],type="l",lwd=12)
